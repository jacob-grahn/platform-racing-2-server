...
require_once __DIR__ . '/../http_server/queries/users/id_to_name.php';
...
require_once __DIR__ . '/../http_server/queries/users/user_select_power.php';
require_once __DIR__ . '/../http_server/queries/users/user_update_power.php';
require_once __DIR__ . '/../http_server/queries/bans/ban_select_active_by_user_id.php';
require_once __DIR__ . '/../http_server/queries/bans/ban_select_active_by_ip.php';
require_once __DIR__ . '/../http_server/queries/bans/bans_select_by_user_id.php';
require_once __DIR__ . '/../http_server/queries/bans/bans_select_by_ip.php';
