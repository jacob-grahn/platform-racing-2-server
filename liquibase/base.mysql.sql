...
CREATE TABLE bans (ban_id MEDIUMINT AUTO_INCREMENT NOT NULL, banned_ip VARCHAR(100) NOT NULL, banned_user_id MEDIUMINT NOT NULL, mod_user_id MEDIUMINT NOT NULL, time BIGINT NOT NULL, expire_time BIGINT NOT NULL, reason VARCHAR(100) NOT NULL, record TEXT NOT NULL, response VARCHAR(500) DEFAULT '' NOT NULL, lifted BIT DEFAULT 0 NOT NULL, mod_name TINYTEXT NOT NULL, banned_name TINYTEXT NOT NULL, lifted_by VARCHAR(100) NULL, lifted_reason VARCHAR(500) NULL, lifted_time BIGINT NULL, account_ban TINYINT(3) DEFAULT 1 NOT NULL, ip_ban TINYINT(3) DEFAULT 1 NOT NULL, notes TEXT NULL, modifed_time BIGINT NULL, modified_time datetime NULL, CONSTRAINT PK_BANS PRIMARY KEY (ban_id));
...
CREATE TABLE campaigns (level_id MEDIUMINT AUTO_INCREMENT NOT NULL, campaign BIT DEFAULT 0 NOT NULL, level_num TINYINT(3) NOT NULL, prize INT NOT NULL, info VARCHAR(100) NOT NULL, prize_type VARCHAR(10) NOT NULL, prize_id INT NOT NULL);

--changeset root:1574908323264-7
CREATE TABLE changing_emails (user_id INT NOT NULL, old_email VARCHAR(100) NOT NULL, new_email VARCHAR(100) NOT NULL, code VARCHAR(30) NOT NULL, date datetime NOT NULL, change_id INT AUTO_INCREMENT NOT NULL, request_ip VARCHAR(20) NOT NULL, confirm_ip VARCHAR(20) NULL, status VARCHAR(10) NOT NULL, CONSTRAINT PK_CHANGING_EMAILS PRIMARY KEY (change_id));
...
CREATE TABLE folding_at_home (user_id MEDIUMINT NOT NULL, crown_hat BIT DEFAULT 0 NOT NULL, cowboy_hat BIT DEFAULT 0 NOT NULL, r1 BIT DEFAULT 0 NOT NULL, r2 BIT DEFAULT 0 NOT NULL, r3 BIT DEFAULT 0 NOT NULL, r4 BIT DEFAULT 0 NOT NULL, r5 BIT DEFAULT 0 NOT NULL, CONSTRAINT PK_FOLDING_AT_HOME PRIMARY KEY (user_id));
...
CREATE TABLE levels (level_id MEDIUMINT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT 0 NOT NULL, version MEDIUMINT DEFAULT 1 NOT NULL, live BIT DEFAULT 0 NOT NULL, ip VARCHAR(30) NOT NULL, title VARCHAR(50) DEFAULT '' NOT NULL, rating FLOAT(12) DEFAULT 0 NOT NULL, votes INT DEFAULT 0 NOT NULL, time INT DEFAULT 0 NOT NULL, note TINYTEXT NOT NULL, min_level TINYINT(3) DEFAULT 0 NOT NULL, song TINYINT(3) DEFAULT 0 NOT NULL, play_count INT DEFAULT 0 NOT NULL, pass VARCHAR(40) NULL, type VARCHAR(1) DEFAULT 'r' NOT NULL, CONSTRAINT PK_LEVELS PRIMARY KEY (level_id));

--changeset root:1574908323264-23
CREATE TABLE messages (message_id INT AUTO_INCREMENT NOT NULL, to_user_id MEDIUMINT DEFAULT 0 NOT NULL, from_user_id MEDIUMINT DEFAULT 0 NOT NULL, message TEXT NOT NULL, guild_message BIT DEFAULT 0 NOT NULL, time INT DEFAULT 0 NOT NULL, ip VARCHAR(30) NOT NULL, CONSTRAINT PK_MESSAGES PRIMARY KEY (message_id));

--changeset root:1574908323264-24
CREATE TABLE messages_reported (message_id INT NOT NULL, to_user_id MEDIUMINT DEFAULT 0 NOT NULL, from_user_id MEDIUMINT DEFAULT 0 NOT NULL, message TEXT NOT NULL, sent_time INT NOT NULL, reported_time INT DEFAULT 0 NOT NULL, from_ip VARCHAR(30) NOT NULL, reporter_ip VARCHAR(30) NOT NULL, archived BIT DEFAULT 0 NOT NULL, CONSTRAINT PK_MESSAGES_REPORTED PRIMARY KEY (message_id), UNIQUE (message_id));
...
CREATE TABLE new_levels (level_id MEDIUMINT NOT NULL, time INT DEFAULT 0 NOT NULL, ip VARCHAR(30) NOT NULL, CONSTRAINT PK_NEW_LEVELS PRIMARY KEY (level_id));
...
CREATE TABLE ratings (level_id MEDIUMINT DEFAULT 0 NOT NULL, user_id MEDIUMINT DEFAULT 0 NOT NULL, rating TINYINT(3) DEFAULT 0 NOT NULL, weight TINYINT(3) DEFAULT 0 NOT NULL, time INT DEFAULT 0 NOT NULL, ip VARCHAR(30) NOT NULL);
