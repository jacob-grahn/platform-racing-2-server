...
function describeSuperBooster($user, $server)
{
    ...
    $d->imgUrl = '/img/vault/Super-Booster-112x63.png';
    $d->imgUrlSmall = '/img/vault/Super-Booster-112x63.png';
    $d->price = 0;
...
function describeFred()
{
    ...
    $d->imgUrl = '/img/vault/Guild-de-Fred-112x63.png';
    $d->imgUrlSmall = '/img/vault/Guild-de-Fred-40x40.png';
    $d->price = 20;
...
function describeGhost()
{
    ...
    $d->imgUrl = '/img/vault/Guild-de-Ghost-112x63.png';
    $d->imgUrlSmall = '/img/vault/Guild-de-Ghost-40x40.png';
    $d->price = 10;
...
function describeArtifact()
{
    ...
    $d->imgUrl = '/img/vault/Avatar-112x63.png';
    $d->imgUrlSmall = '/img/vault/Avatar-40x40.png';
    $d->price = 30;
...
function describeHappyHour($server)
{
    ...
    $d->slug = 'happy-hour';
    $d->title = 'Happy Hour';
    $d->imgUrl = '/img/vault/Happy-Hour-112x63.png';
    $d->imgUrlSmall = '/img/vault/Happy-Hour-40x40.png';
    $d->price = 50;
...
function describeRankRental($pdo, $user)
{
    ...
    $d->slug = 'rank-rental';
    $d->title = 'Rank Token++';
    $d->imgUrl = '/img/vault/Rank-Token-112x63.png';
    $d->imgUrlSmall = '/img/vault/Rank-Token-40x40.png';
...
function describeKing($user)
{
    ...
    $d->slug = 'king-set';
    $d->title = 'Wise King';
    $d->imgUrl = '/img/vault/King-Set-112x63.png';
    $d->imgUrlSmall = '/img/vault/King-Set-40x40.png';
    $d->price = 30;
...
function describeQueen($user)
{
    ...
    $d->slug = 'queen-set';
    $d->title = 'Wise Queen';
    $d->imgUrl = '/img/vault/Queen-Set-112x63.png';
    $d->imgUrlSmall = '/img/vault/Queen-Set-40x40.png';
    $d->price = 30;
...
function describeDjinn($user)
{
    ...
    $d->slug = 'djinn-set';
    $d->title = 'Frost Djinn';
    $d->imgUrl = '/img/vault/Djinn-Set-112x63.png';
    $d->imgUrlSmall = '/img/vault/Djinn-Set-40x40.png';
    $d->price = 30;
...
function describePrivateServer1($user, $guild)
{
    ...
    $d->imgUrl = '/img/vault/Private-Server-1-112x63.png';
    $d->imgUrlSmall = '/img/vault/Private-Server-40x40.png';
    $d->price = 20;
...
function describePrivateServer30($user, $guild)
{
    ...
    $d->imgUrl = '/img/vault/Private-Server-30-112x63.png';
    $d->imgUrlSmall = '/img/vault/Private-Server-40x40.png';
    $d->price = 300;
