...
class Prizes {
	...
	public static function init() {
		...
		self::$TACO_FEET = new Prize( self::TYPE_FEET, Feet::TACO, 'Taco Foot' ); //random levels
		self::$SLENDER_FEET = new Prize( self::TYPE_FEET, Feet::SLENDER, 'Slender Foot' ); //-Deliverance- by changelings
