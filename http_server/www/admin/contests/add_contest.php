...
function output_form($pdo, $user_id)
{
    ...
    echo 'Description: <input type="text" name="description"> (short description of what the contest involves, max: 255 characters)<br>';
    echo 'Contest URL: <input type="text" name="url"> (link to contest homepage, max: 255 characters)<br>';
    echo 'Host User ID: <input type="text" name="host_id"> (the user ID of the PR2 player that is hosting this contest, max: 10 numbers)<br>';
    echo 'Awarding: <input type="text" name="awarding"> (summary of the prizes the contest is awarding, max: 255 characters)<br>';
    echo 'Max Awards (per week): <input type="text" name="max_awards"> (max times a contest owner can award prizes per week, suggested: 1-3, min: 1, max: 50)<br>';
