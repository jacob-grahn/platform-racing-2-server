    ...
    if (!isset($processed_names[$lower_name])) {
        ...
        try {
            ...
            award_prize(
                ...
                'r1',
                1,
                '+1 rank token in Platform Racing 2'
            );
            award_prize(
                $pdo,
                $user_id,
            ...
            award_prize(
                ...
                'crown_hat',
                5000,
                'Crown Hat in Platform Racing 2'
            );
            ...
            award_prize(
                ...
                'cowboy_hat',
                100000,
                'Super Flying Cowboy Hat in Platform Racing 2'
            );
            ...
            award_prize(
                ...
                'r4',
                1000000,
                '+1 rank increase in Platform Racing 2'
            );
            award_prize(
                $pdo,
                $user_id,
...
function award_prize($pdo, $user_id, $name, $score, $row, $column_name, $min_score, $prize_str)
{
    if ($score >= $min_score && $row->{$column_name} != 1) {
        ...
        //send them a PM
        $message = "$name, congratulations on earning $min_score points for "
            ."Team Jiggmin! You have been awarded with a $prize_str. \n\n"
